...
internal static class ProductoController
{
    ...
    public static Producto Insertar(Producto p) //insertar Producto a la BD y obtener el ID
    {
    ...
    public static string GenerateProductCode(string nombre)
    {
